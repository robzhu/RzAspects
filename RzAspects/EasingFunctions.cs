...
namespace RzAspects
{
    ...
    {
        public static Func<double, double, double, double, double> EquationToFunc( EasingFunctionId equation )
        {
            Func<double, double, double, double, double> easing = Linear;
            switch( equation )
            {
                case EasingFunctionId.BackEaseIn: return BackEaseIn;
                case EasingFunctionId.BackEaseInOut: return BackEaseInOut;
                case EasingFunctionId.BackEaseOut: return BackEaseOut;
                case EasingFunctionId.BackEaseOutIn: return BackEaseOutIn;

                case EasingFunctionId.BounceEaseIn: return BounceEaseIn;
                case EasingFunctionId.BounceEaseInOut: return BounceEaseInOut;
                case EasingFunctionId.BounceEaseOut: return BounceEaseOut;
                case EasingFunctionId.BounceEaseOutIn: return BounceEaseOutIn;

                case EasingFunctionId.CircEaseIn: return CircEaseIn;
                case EasingFunctionId.CircEaseInOut: return CircEaseInOut;
                case EasingFunctionId.CircEaseOut: return CircEaseOut;
                case EasingFunctionId.CircEaseOutIn: return CircEaseOutIn;

                case EasingFunctionId.CubicEaseIn: return CubicEaseIn;
                case EasingFunctionId.CubicEaseInOut: return CubicEaseInOut;
                case EasingFunctionId.CubicEaseOut: return CubicEaseOut;
                case EasingFunctionId.CubicEaseOutIn: return CubicEaseOutIn;

                case EasingFunctionId.ElasticEaseIn: return ElasticEaseIn;
                case EasingFunctionId.ElasticEaseInOut: return ElasticEaseInOut;
                case EasingFunctionId.ElasticEaseOut: return ElasticEaseOut;
                case EasingFunctionId.ElasticEaseOutIn: return ElasticEaseOutIn;

                case EasingFunctionId.ExpoEaseIn: return ExpoEaseIn;
                case EasingFunctionId.ExpoEaseInOut: return ExpoEaseInOut;
                case EasingFunctionId.ExpoEaseOut: return ExpoEaseOut;
                case EasingFunctionId.ExpoEaseOutIn: return ExpoEaseOutIn;

                //case Equations.Linear: return Linear;

                case EasingFunctionId.QuadEaseIn: return QuadEaseIn;
                case EasingFunctionId.QuadEaseInOut: return QuadEaseInOut;
                case EasingFunctionId.QuadEaseOut: return QuadEaseOut;
                case EasingFunctionId.QuadEaseOutIn: return QuadEaseOutIn;

                case EasingFunctionId.QuadraticRiseFall: return QuadraticRiseFall;

                case EasingFunctionId.QuartEaseIn: return QuartEaseIn;
                case EasingFunctionId.QuartEaseInOut: return QuartEaseInOut;
                case EasingFunctionId.QuartEaseOut: return QuartEaseOut;
                case EasingFunctionId.QuartEaseOutIn: return QuartEaseOutIn;

                case EasingFunctionId.QuintEaseIn: return QuintEaseIn;
                case EasingFunctionId.QuintEaseInOut: return QuintEaseInOut;
                case EasingFunctionId.QuintEaseOut: return QuintEaseOut;
                case EasingFunctionId.QuintEaseOutIn: return QuintEaseOutIn;

                case EasingFunctionId.SineEaseIn: return SineEaseIn;
                case EasingFunctionId.SineEaseInOut: return SineEaseInOut;
                case EasingFunctionId.SineEaseOut: return SineEaseOut;
                case EasingFunctionId.SineEaseOutIn: return SineEaseOutIn;
            }
            return easing;
        }
        ...
        /// <summary>
        /// Quadratic (t^2) Easing equation function for a quadratic that starts and ends at a specified value, and hits a specific peak at d/2
        /// </summary>
        /// <param name="t">Current time in seconds.</param>
        /// <param name="b">Start/end value.</param>
        /// <param name="c">Peak value.</param>
        /// <param name="d">Duration of animation.</param>
        public static double QuadraticRiseFall( double t, double b, double c, double d )
        {
            return c + ( ( b - c ) * Math.Pow( ( t - ( d / 2 ) ), 2 ) / Math.Pow( d / 2, 2 ) );
        }
